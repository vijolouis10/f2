...
def product_gallery(request):
    ...
    return render(request, 'myadmin/product_gallary.html', context)
...
def AddVaraiation(request):
    ...
    return render(request, 'myadmin/add_variation.html', context)
...
def add_gallery(request):
    ...
    return render(request, 'myadmin/add_gallery.html', context)
